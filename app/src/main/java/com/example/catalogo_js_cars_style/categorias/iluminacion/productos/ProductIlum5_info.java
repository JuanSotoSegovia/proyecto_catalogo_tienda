...
public class ProductIlum5_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_stock = (TextView)findViewById(R.id.txt_stock_pro5_ilu);
        cali = (RatingBar)findViewById(R.id.rtb_pro5_ilu);

        cali.setRating(obj_ilu.getCalificacion()[4]);
        //bloquear Ratingbar
        cali.setIsIndicator(true);

        txt_nombre.setText(obj_ilu.getNombreIluminacion()[4]);
        txt_precio.setText("$"+obj_ilu.getPrecioIluminacion()[4]);
        txt_descrip.setText(obj_ilu.getDescripcionIluminacion()[4]);
