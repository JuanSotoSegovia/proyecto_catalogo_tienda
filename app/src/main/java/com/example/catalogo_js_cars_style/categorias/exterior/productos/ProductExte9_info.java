...
public class ProductExte9_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_stock = (TextView)findViewById(R.id.txt_stock_pro9_ext);
        cali = (RatingBar)findViewById(R.id.rtb_pro9_ext);

        cali.setRating(obj_ext.getCalificcion()[8]);
        //bloquear Ratingbar
