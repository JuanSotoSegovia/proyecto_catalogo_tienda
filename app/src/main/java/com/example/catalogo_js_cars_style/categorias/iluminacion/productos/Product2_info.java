...
public class Product2_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_stock = (TextView)findViewById(R.id.txt_stock_pro2_ilu);
        cali = (RatingBar)findViewById(R.id.rtb_pro2_ilu);

        cali.setRating(obj_ilu.getCalificacion()[1]);
        //bloquear Ratingbar
        cali.setIsIndicator(true);

        txt_nombre.setText(obj_ilu.getNombreIluminacion()[1]);
        txt_precio.setText("$"+obj_ilu.getPrecioIluminacion()[1]);
        txt_descrip.setText(obj_ilu.getDescripcionIluminacion()[1]);
