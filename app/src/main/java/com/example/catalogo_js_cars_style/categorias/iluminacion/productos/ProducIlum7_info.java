...
public class ProducIlum7_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_stock = (TextView)findViewById(R.id.txt_stock_pro7_ilu);
        cali = (RatingBar)findViewById(R.id.rtb_pro7_ilu);

        cali.setRating(obj_ilu.getCalificacion()[6]);
        //bloquear Ratingbar
        cali.setIsIndicator(true);

        txt_nombre.setText(obj_ilu.getNombreIluminacion()[6]);
        txt_precio.setText("$"+obj_ilu.getPrecioIluminacion()[6]);
        txt_descrip.setText(obj_ilu.getDescripcionIluminacion()[6]);
