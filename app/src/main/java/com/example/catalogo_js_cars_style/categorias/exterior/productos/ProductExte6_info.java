...
public class ProductExte6_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_stock = (TextView)findViewById(R.id.txt_stock_pro6_ext);
        cali = (RatingBar)findViewById(R.id.rtb_pro6_ext);

        cali.setRating(obj_ext.getCalificcion()[5]);
        //bloquear Ratingbar
